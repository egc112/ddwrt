...
Enter the Xvortex CFE which wil change the router to a single boot device with 64 Kb nvram.   
...
5.	Hard Reset to defaults: power down, press blue WPS button, power up while holding blue WPS button for about 10 sec until the light starts blinking, wait till the router has booted fully   
